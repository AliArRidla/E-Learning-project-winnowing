...
<main id="main">
    <div>
        ...
        <!-- Modal delete guru -->
        <div wire:ignore.self class="modal fade" id="mdlDelSiswa" data-backdrop="static" data-keyboard="false"
                tabindex="-1" data-focus="true" data-show="true" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="mdlDelSiswaLabel">Konfirmasi Hapus</h5>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary mr-auto" data-dismiss="modal"
                            wire:click="reload()">Tutup</button>
