                                ...
                                <div class="overview-wrap">
                                    @if ($dataMapel != null)
                                        @foreach ($dataMapel as $i)
                                            <h2 class="title-1">Daftar Ulangan {{ $i->nama_kelas }} -
                                                {{ $i->nama_mapel }}</h2>
                                ...
                                <div class="card-body card-block">
                                    <div class="form-group">
                                        ...
                                        <select name="tujuan" id="tujuan" class="form-control"
                                            wire:model.debounced.800ms="tujuan" hidden>
                                            @if ($dataMapel != null)
                                                @foreach ($dataMapel as $i)
                                                    <option value="{{ $i->dmid }}">{{ $i->nama_mapel }} -
                                                        {{ $i->nama_kelas }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:model.defer="judul_ulangan" type="text" id="judul_ulangan"
                                            class="form-control @error('judul_ulangan') is-invalid @enderror"
                                            name="judul_ulangan"
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            ...
                                            <div>
                                                <small>Jika diaktifkan maka Anda yang akan menetapkan poin dari setiap
                                                    soal.</small><br>
                                                <small><strong>Jika nonaktif maka akan digunakan rumus sistem:
                                                        100/jumlah soal x jumlah jawaban benar</strong></small>
                                            </div>
                                        </div>
                                        @error('is_poin')
                                            <span id="error-msg">{{ $message }}</span>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <input wire:ignore.self type="date" wire:model="tgl_ulangan"
                                                class="form-control @error('tgl_ulangan') is-invalid @enderror"
                                                min="{{ date('Y-m-d') }}">
                                        </div>
                                        @php
                                            $hari_ini;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:ignore type="text"
                                            class="waktu form-control @error('twaktu_mulai') is-invalid @enderror"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:ignore type="text"
                                            class="waktus form-control @error('twaktu_selesai') is-invalid @enderror"
                                            name="waktus" id="waktus" readonly>
                                        <input type="text" name="twaktus" id="twaktus" wire:model="twaktu_selesai"
                                            hidden>
                ...
                <div class="modal-content">
                    @if ($ulid != null)
                        ...
                        <div class="modal-body">
                            ...
                            @endphp
                            Apakah Anda yakin ingin menghapus ulangan <strong>{{ $dmjudul_ulangan }}</strong> pada
                            tanggal <strong>{{ $d }}</strong>
                            untuk kelas <strong>{{ $nama_kelas }}</strong> dengan mapel
                            <strong>{{ $nama_mapel }}</strong>?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger mr-auto"
                                wire:click="delUl({{ $ulid }})">Yakin!</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                wire:click="allNull">Tidak</button>
                        </div>
                    @else
                        <div class="modal-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        @if ($emjudul_ulangan != null)
                            <div class="form-group">
                                ...
                                <input wire:model.defer="emjudul_ulangan" type="text" id="emjudul_ulangan"
                                    class="form-control @error('emjudul_ulangan') is-invalid @enderror"
                                    name="emjudul_ulangan"
                                    placeholder="Contoh: Ulangan Harian 1 / Ulangan Materi Aljabar">
                        ...
                        <div class="form-group">
                            ...
                            <input wire:ignore type="text" name="emtwaktu_mulai" id="emtwaktu_mulai"
                                class="emtwaktu_mulai form-control @error('emtwaktu_mulai') is-invalid @enderror"
                                readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input wire:ignore type="text" name="emtwaktu_selesai" id="emtwaktu_selesai"
                                class="emtwaktu_selesai form-control @error('emtwaktu_selesai') is-invalid @enderror"
                                readonly>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-warning"
                            wire:click="editUl({{ $ulid }})">Edit</button>
                    </div>
                    <script>
  ...
  <!-- SET POIN -->
   ...
   {{-- <div class="modal fade" id="pilganEssayModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog" role="document">
       <div class="modal-content">
         <div class="modal-header">
           <h5 class="modal-title" id="pilihan">PILIH SALAH SATU</h5>
           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
             <span aria-hidden="true">&times;</span>
           </button>
         </div>
         <div class="modal-body">
            <a href="" class="btn btn-primary url1">Essay</a>
            <a class="btn btn-success url2" data-toggle="modal" data-dismiss="modal" data-target="#pilganModal" href="">Pilihan Ganda</a>
         </div>
             <div class="modal-footer">
                 <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
             </div>
   ...
   <script>
       $(document).ready(function(){
         $('.btn-modal-pilganEssay').on('click', function(){
